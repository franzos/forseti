...
Forseti is an identity and access service, so I take reports about it seriously.
...
The Forseti codebase in this repository is in scope. Issues in third-party
dependencies are better reported upstream, though I do want to hear about it if a
dependency issue is exploitable through how Forseti uses it.
