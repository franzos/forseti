...
settings-profile-public-label-username = Benutzername
settings-profile-username-heading = Benutzername
settings-profile-username-saved = Benutzername gespeichert.
settings-profile-username-save = Benutzername speichern
settings-profile-username-hint = Buchstaben, Ziffern, Punkte, Unterstriche und Bindestriche. Anwendungen, die ein Konto für Sie anlegen, verwenden diesen möglicherweise als Ihren dortigen Benutzernamen. Bleibt das Feld leer, wird kein Benutzername weitergegeben. Sie können ihn nur alle 30 Tage ändern, und ein freigegebener Benutzername kann von niemandem sonst übernommen werden.
...
settings-profile-username-invalid = Dieser Benutzername ist nicht zulässig. Verwenden Sie 2 bis 39 Buchstaben, Ziffern, Punkte, Unterstriche oder Bindestriche, beginnend und endend mit einem Buchstaben oder einer Ziffer.
settings-profile-username-taken = Dieser Benutzername ist nicht verfügbar.
settings-profile-username-cooldown = Sie können Ihren Benutzernamen nur alle 30 Tage ändern.
