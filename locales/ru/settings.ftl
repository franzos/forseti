...
settings-profile-public-label-username = Имя пользователя
settings-profile-username-heading = Имя пользователя
settings-profile-username-saved = Имя пользователя сохранено.
settings-profile-username-save = Сохранить имя пользователя
settings-profile-username-hint = Буквы, цифры, точки, подчёркивания и дефисы. Приложения, которые создают для вас учётную запись, могут использовать его как ваше имя пользователя. Оставьте поле пустым — имя пользователя передаваться не будет. Менять его можно раз в 30 дней, а освобождённое имя пользователя больше никто не сможет занять.
...
settings-profile-username-invalid = Это имя пользователя недопустимо. Используйте от 2 до 39 букв, цифр, точек, подчёркиваний или дефисов, начиная и заканчивая буквой или цифрой.
settings-profile-username-taken = Это имя пользователя недоступно.
settings-profile-username-cooldown = Менять имя пользователя можно раз в 30 дней.
