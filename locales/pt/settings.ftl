...
settings-profile-public-label-username = Nome de utilizador
settings-profile-username-heading = Nome de utilizador
settings-profile-username-saved = Nome de utilizador guardado.
settings-profile-username-save = Guardar nome de utilizador
settings-profile-username-hint = Letras, dígitos, pontos, sublinhados e hífenes. As aplicações que criam uma conta para si podem usá-lo como o seu nome de utilizador nessas aplicações. Deixe vazio e nenhum nome de utilizador é partilhado. Só o pode alterar de 30 em 30 dias, e um nome de utilizador que liberte não pode ser ocupado por mais ninguém.
...
settings-profile-username-invalid = Esse nome de utilizador não é permitido. Use entre 2 e 39 letras, dígitos, pontos, sublinhados ou hífenes, começando e terminando com uma letra ou um dígito.
settings-profile-username-taken = Esse nome de utilizador não está disponível.
settings-profile-username-cooldown = Só pode alterar o seu nome de utilizador de 30 em 30 dias.
