...
settings-profile-public-label-username = Nome utente
settings-profile-username-heading = Nome utente
settings-profile-username-saved = Nome utente salvato.
settings-profile-username-save = Salva nome utente
settings-profile-username-hint = Lettere, cifre, punti, trattini bassi e trattini. Le applicazioni che creano un account per te potrebbero usarlo come nome utente. Lascia il campo vuoto e nessun nome utente verrà condiviso. Puoi modificarlo solo una volta ogni 30 giorni e un nome utente che rilasci non potrà essere preso da nessun altro.
...
settings-profile-username-invalid = Questo nome utente non è consentito. Usa da 2 a 39 lettere, cifre, punti, trattini bassi o trattini, iniziando e terminando con una lettera o una cifra.
settings-profile-username-taken = Questo nome utente non è disponibile.
settings-profile-username-cooldown = Puoi modificare il tuo nome utente solo una volta ogni 30 giorni.
