...
admin-client-section-logo = شعار شاشة الموافقة
admin-client-logo-intro = يُعرض للمستخدمين على شاشة الموافقة لهذا التطبيق. يُرفع هنا بدلاً من أخذه من logo_uri الخاص بالعميل، بحيث تُقدَّم الصورة من هذا الخادم ولا يصل عنوان IP لأي مستخدم إلى التطبيق قبل موافقته.
admin-client-logo-file = ملف الشعار
admin-client-logo-hint = PNG أو JPEG أو WebP، حتى ٢٥٦ كيلوبايت. الصور المربعة هي الأنسب.
admin-client-logo-remove = إزالة الشعار الحالي
admin-client-logo-save = حفظ الشعار
...
admin-status-audit-webhook-accept-list = إدخالات قائمة القبول لخطاف تدقيق الويب
admin-status-audit-webhook-last-matched = آخر إدخال مطابق لخطاف تدقيق الويب
admin-status-audit-webhook-last-matched-none = لا شيء منذ الإقلاع
