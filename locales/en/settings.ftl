...
settings-profile-public-label-username = Username
settings-profile-username-heading = Username
settings-profile-username-saved = Username saved.
settings-profile-username-save = Save username
settings-profile-username-hint = Letters, digits, dots, underscores and hyphens. Apps that create an account for you may use this as your username there. Leave it empty and no username is shared. You can only change it once every 30 days, and a username you release can't be taken by anyone else.
...
settings-profile-username-invalid = That username isn't allowed. Use 2 to 39 letters, digits, dots, underscores or hyphens, starting and ending with a letter or digit.
settings-profile-username-taken = That username isn't available.
settings-profile-username-cooldown = You can only change your username once every 30 days.
