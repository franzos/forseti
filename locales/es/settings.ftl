...
settings-profile-public-label-username = Nombre de usuario
settings-profile-username-heading = Nombre de usuario
settings-profile-username-saved = Nombre de usuario guardado.
settings-profile-username-save = Guardar nombre de usuario
settings-profile-username-hint = Letras, dígitos, puntos, guiones bajos y guiones. Las aplicaciones que crean una cuenta para ti pueden usarlo como tu nombre de usuario allí. Déjalo vacío y no se compartirá ningún nombre de usuario. Solo puedes cambiarlo cada 30 días, y un nombre de usuario que liberes no podrá tomarlo nadie más.
...
settings-profile-username-invalid = Ese nombre de usuario no está permitido. Usa entre 2 y 39 letras, dígitos, puntos, guiones bajos o guiones, empezando y terminando con una letra o un dígito.
settings-profile-username-taken = Ese nombre de usuario no está disponible.
settings-profile-username-cooldown = Solo puedes cambiar tu nombre de usuario cada 30 días.
