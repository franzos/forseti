...
admin-client-section-logo = โลโก้บนหน้าจอให้ความยินยอม
admin-client-logo-intro = แสดงแก่ผู้ใช้บนหน้าจอให้ความยินยอมของแอปนี้ อัปโหลดที่นี่แทนการดึงจาก logo_uri ของไคลเอนต์ เพื่อให้รูปภาพถูกส่งจากเซิร์ฟเวอร์นี้ และไม่มี IP ของผู้ใช้ไปถึงแอปก่อนที่ผู้ใช้จะให้ความยินยอม
admin-client-logo-file = ไฟล์โลโก้
admin-client-logo-hint = PNG, JPEG หรือ WebP ขนาดไม่เกิน 256 KB รูปสี่เหลี่ยมจัตุรัสให้ผลดีที่สุด
admin-client-logo-remove = ลบโลโก้ปัจจุบัน
admin-client-logo-save = บันทึกโลโก้
...
admin-status-audit-webhook-accept-list = รายการในรายการอนุญาตของ audit webhook
admin-status-audit-webhook-last-matched = รายการ audit webhook ที่ตรงล่าสุด
admin-status-audit-webhook-last-matched-none = ไม่มีตั้งแต่เริ่มระบบ
