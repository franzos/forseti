...
settings-profile-public-label-username = Nom d'utilisateur
settings-profile-username-heading = Nom d'utilisateur
settings-profile-username-saved = Nom d'utilisateur enregistré.
settings-profile-username-save = Enregistrer le nom d'utilisateur
settings-profile-username-hint = Lettres, chiffres, points, tirets bas et traits d'union. Les applications qui créent un compte pour vous peuvent l'utiliser comme nom d'utilisateur. Laissez le champ vide et aucun nom d'utilisateur ne sera partagé. Vous ne pouvez le modifier qu'une fois tous les 30 jours, et un nom d'utilisateur que vous libérez ne pourra être repris par personne d'autre.
...
settings-profile-username-invalid = Ce nom d'utilisateur n'est pas autorisé. Utilisez 2 à 39 lettres, chiffres, points, tirets bas ou traits d'union, en commençant et en terminant par une lettre ou un chiffre.
settings-profile-username-taken = Ce nom d'utilisateur n'est pas disponible.
settings-profile-username-cooldown = Vous ne pouvez modifier votre nom d'utilisateur qu'une fois tous les 30 jours.
